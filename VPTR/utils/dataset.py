...
def get_dataloader(data_set_name, batch_size, train_dir, val_dir, test_past_frames = 11, test_future_frames = 11, ngpus = 1, num_workers = 1):
    if data_set_name == 'KTH':
        ...
        KTHTrainData = KTHDataset(train_dir, transform = train_transform, train = True, val = True, 
        ...
        KTHTestData = KTHDataset(val_dir, transform = test_transform, train = False, val = False, 
        ...
        train_set = MovingMNISTDataset(train_dir.joinpath('moving-mnist-train.npz'), train_transform)
        val_set = MovingMNISTDataset(train_dir.joinpath('moving-mnist-valid.npz'), train_transform)
        test_set = MovingMNISTDataset(val_dir.joinpath('moving-mnist-test.npz'), test_transform)
        ...
        BAIR_train_whole_set = BAIRDataset(train_dir.joinpath('data'), transform, color_mode = 'RGB', 
                                num_past_frames = 11, num_future_frames = 11)()
