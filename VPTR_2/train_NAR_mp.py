...
def init_models(img_channels, encC, encH, encW, dropout, out_layer, rpe, TSLMA_flag, rank, batch_size, world_size,
                ...
                num_past_frames = 11, num_future_frames = 11, init_Disc = False, train_Disc = False):
...
def main_worker(rank, args, world_size, img_channels, encC, encH, encW, dropout, out_layer, TSLMA_flag,
                ...
                resume_Transformer_ckpt = None, num_encoder_layers = 4, num_decoder_layers = 8, num_past_frames = 11, 
                num_future_frames = 11, init_Disc = False, train_Disc = False,
